...
class NLPApp:
    ...
    def __init__(self):
        ...
        self.root.iconbitmap('resources/favicon1.ico')
    ...
    def perform_login(self):
        ...
        self.dbo.search(email,password)
    ...
    def ner_gui(self):
        ...
        ner_btn = Button(self.root, text='Named Entity Recognition', command=self.do_ner)
        ner_btn.pack(pady=(10, 10))
    ...
    def emotion_gui(self):
        ...
        self.emotion_result.configure(font=('verdana', 13))
